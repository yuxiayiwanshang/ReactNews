...
export default class PCNewsImgBlock extends React.Component {
	...
	componentWillMount() {
		...
		fetch
		("http://newsapi.gugujiankong.com/Handler.ashx?action=getnews&type=" + this.props.type + "&count=" + this.props.count, myFetchOptions)
         ...
         <div key={index} className="imageblock">
           <Link to={`details/${newsItem.uniquekey}`} target="_blank">
             <div className="custom-image">
               <img alt="/" style={styleImage} src={newsItem.thumbnail_pic_s}></img>
             </div>
